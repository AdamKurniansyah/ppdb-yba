...
<nav class="bg-gray-800 rounded-xl shadow-xl mx-auto max-w-7xl sm:px-6 lg:px-8" x-data="{ isOpen: false }">
        ...
        <div class="flex items-center">
          <div class="hidden md:block">
            <div class="ml-0 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/registration-flow" :active="request()->is('registration-flow')">ALUR PENDAFTARAN</x-nav-link>
              <x-nav-link href="/registration-form" :active="request()->is('registration-form')">FORMULIR PENDAFTARAN</x-nav-link>
              <x-nav-link href="/payment-confirmation" :active="request()->is('payment-confirmation')">KONFIRMASI PEMBAYARAN</x-nav-link>
              <x-nav-link href="#" :active="request()->is('#')">PANDUAN</x-nav-link>
            </div>
          </div>
        </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <x-nav-link-mobile href="/registration-flow" :active="request()->is('registration-flow')">ALUR PENDAFTARAN</x-nav-link-mobile>
        <x-nav-link-mobile href="/registration-form" :active="request()->is('registration-form')">FORMULIR PENDAFTARAN</x-nav-link-mobile>
        <x-nav-link-mobile href="/payment-confirmation" :active="request()->is('payment-confirmation')">KONFIRMASI PEMBAYARAN</x-nav-link-mobile>
        <x-nav-link-mobile href="#" :active="request()->is('#')">PANDUAN</x-nav-link-mobile>
      </div>
